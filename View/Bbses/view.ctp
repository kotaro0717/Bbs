...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo __d('bbses', 'Post title');?></li>
</ol>

<!-- 記事タイトル -->
	<h3><?php echo $title="サンプル記事1"; ?></h3>
...
<!-- 親記事 -->
	...
	<div class="text-left">
		<div class="text-left" style="float:right;">
			...
			<a href="#" tooltip="<?php echo __d('bbses', 'Edit post'); ?>"><span class="glyphicon glyphicon-edit"></span></a>
			<a href="#" tooltip="<?php echo __d('bbses', 'Delete post'); ?>"><span class="glyphicon glyphicon-trash"></span></a>
		</div>
