	...
	<div class="text-left">
		...
		<span class="text-left" style="float:right;">
			...
			<div class="btn-group">
				...
				<ul class="dropdown-menu" role="menu">
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . 1 . '/' . $currentVisiblePostRow) ?>"><?php echo __d('bbses', 'Latest post order'); ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . 2 . '/' . $currentVisiblePostRow); ?>"><?php echo __d('bbses', 'Older post order'); ?></a></li>
					<!-- 未実装:未読 -->
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . 3 . '/' . $currentVisiblePostRow); ?>"><?php echo __d('bbses', 'Do not read') . "(未実装)" ; ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . 4 . '/' . $currentVisiblePostRow); ?>"><?php echo __d('bbses', 'Descending order of comments'); ?></a></li>
					<?php if ($contentCreatable) : ?>
						<li><a href="<?php echo $this->Html->url(
								'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . 5 . '/' . $currentVisiblePostRow); ?>"><?php echo __d('bbses', 'Status order'); ?></a></li>
					<?php endif; ?>
				</ul>
			</div>
			...
			<div class="btn-group">
				...
				<button type="button" class="btn btn-default"><?php echo $currentVisiblePostRow . "件"; ?></button>
				<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
					<span class="caret"></span>
					<span class="sr-only">Toggle Dropdown</span>
				</button>
				<ul class="dropdown-menu" role="menu">
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . 1); ?>"><?php echo '1' . "件"; ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . 5); ?>"><?php echo '5' . "件"; ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . 10); ?>"><?php echo '10' . "件"; ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . 20); ?>"><?php echo '20' . "件"; ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . 50); ?>"><?php echo '50' . "件"; ?></a></li>
					<li><a href="<?php echo $this->Html->url(
							'/bbses/bbses/index' . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . 100); ?>"><?php echo '100' . "件"; ?></a></li>
				</ul>
			</div>
		</span>
	</div>
