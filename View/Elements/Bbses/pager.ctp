	...
	<ul class="pagination">
		...
		<?php if (!($currentPage === 1) && !($currentPage === 2)) : ?>
			...
			<li><a href="<?php echo $this->Html->url(
					'/' . $baseUrl . '/' . $frameId . '/' . $minPageNum . '/' . $sortParams . '/' . $currentVisibleRow) ?>">
		...
		<?php elseif ($currentPage === 2) : ?>
			<li><a href="<?php echo $this->Html->url(
					'/' . $baseUrl . '/' . $frameId . '/' . 1 . '/' . $sortParams . '/' . $currentVisibleRow) ?>">
				<?php echo 1; ?></a>
			</li>
		...
		<?php if ($hasNextPage) : ?>
			<li><a href="<?php echo $this->Html->url(
						'/' . $baseUrl . '/' . $frameId . '/' . $nextPageNum . '/' . $sortParams . '/' . $currentVisibleRow) ?>">
		...
		<?php if ($currentPage === 1) : ?>
			<?php if ($hasFourPage) : ?>
				<li><a href="<?php echo $this->Html->url(
						'/' . $baseUrl . '/' . $frameId . '/' . 4 . '/' . $sortParams . '/' . $currentVisibleRow) ?>">
					<?php echo 4; ?></a>
				</li>
			<?php else : ?>
				<li class="disabled">
			...
			<?php if ($hasFivePage) : ?>
				<li><a href="<?php echo $this->Html->url(
						'/' . $baseUrl . '/' . $frameId . '/' . 5 . '/' . $sortParams . '/' . $currentVisibleRow) ?>">
					<?php echo 5; ?></a>
				</li>
			<?php else : ?>
				<li class="disabled">
		...
		<li class="<?php echo ($hasNextPage &&
			...
			<a href="<?php echo ($hasNextPage && $hasFourPage && $hasFivePage && $hasNextPage && $hasNextSecondPage)?
					$this->Html->url(
						'/' . $baseUrl . '/' . $frameId . '/' . $nextPager . '/' . $sortParams . '/' . $currentVisibleRow) : ''; ?>"
					aria-label="Next">
