	...
	<ul class="pagination">
		...
		<?php if (!($currentPage === 1) && !($currentPage === 2)) : ?>
			...
			<li><a href="<?php echo $this->Html->url(
					'/' . $baseUrl . '/' . $frameId . '/' . $bbsPosts['id'] . '/' . $minPageNum . '/' . $sortParams . '/' . $currentVisibleRow . '/' . $narrowDownParams) ?>">
		...
		<?php elseif ($currentPage === 2) : ?>
			<li><a href="<?php echo $this->Html->url(
					'/' . $baseUrl . '/' . $frameId . '/' . $bbsPosts['id'] . '/' . 1 . '/' . $sortParams . '/' . $currentVisibleRow . '/' . $narrowDownParams) ?>">
				<?php echo 1; ?></a>
			</li>
